...
import { Code2, Palette, ShoppingBag, Building2, Gamepad2, BookOpen, CheckCircle, Users, Calendar, Globe } from 'lucide-react';
...
const PortfolioDetails: React.FC = () => {
  ...
  const [activeProject, setActiveProject] = useState<string>(searchParams.get('project') || 'tech-innovate');
  ...
  const projects: Record<string, ProjectDetail> = {
    'PersonaMatch': {
      ...
      image: "https://vivarancreations.com/wp-content/uploads/2025/04/WhatsApp-Image-2025-04-06-at-17.31.51_301a8173-768x711.jpg",
