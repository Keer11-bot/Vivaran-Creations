...
const Navbar: React.FC = () => {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-dark-300/90 backdrop-blur-md py-4 shadow-lg' : 'bg-transparent py-6'
        }`}
    >
        ...
        <div className="flex items-center justify-between w-full">
          ...
          >
            <Link to="/" className="flex items-center">
              ...
              />
              {/* <span className="text-2xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">Vivaran Creations</span> */}
            </Link>
          </motion.div>
